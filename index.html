...
<head>
    ...
    <style>
        * {
        ...
        body {
            background: url('imgs/bg1.jpg') top center no-repeat fixed;
...
<div class="pag-y-content bg-white">
    <div class="container px-4 py-5" id="custom-cards">
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('imgs/unsplash-photo-1.png');">
            ...
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('imgs/unsplash-photo-2.png');">
                    <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
            ...
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('imgs/unsplash-photo-3.png');">
    ...
    <div class="px-4 pt-5 text-center border-bottom">
        ...
        <div class="overflow-hidden" style="max-height: 30vh;">
            <div class="container px-5">
                <img src="https://getbootstrap.com/docs/5.1/examples/heroes/bootstrap-docs.png"
